...
echo "Progress: one updating dashboard line with X/Y, work %, levels, elapsed and ETA."
echo "Detailed per-pair logs are stored under $OUTDIR/parts/<PAIR>/worker.log"
echo "CONFIG=$CONFIG"
